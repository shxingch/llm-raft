...
from common.vehicle import Behaviour, Vehicle, Action
...
@dataclass
class EgoVehDecision:
    """Decision of the ego vehicle for the new desicion type: acc,steering(avoid conflicts with EgoDecision)"""
    ego_veh_id: str
    ego_behaviour: Behaviour
    ego_action: Action
