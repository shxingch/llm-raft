...
class MovingScene:
    ...
    def exportScene(self):
        ...
        vehicles = {
            ...
            'carInAoI': self._safe_export_vehicle_dicts(self.vehINAoI.values()),
            'outOfAoI': self._safe_export_vehicle_dicts(self.outOfAoI.values()),
        }

        return roadgraph, vehicles

    def _safe_export_vehicle_dicts(self, vehicles):
        exported = []
        for vehicle in vehicles:
            try:
                exported.append(vehicle.export2Dict(self.netInfo))
            except TypeError:
                continue
        return exported
